...
from utilities.batchnorm import*
...
class ICNet(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet50', aux=False, jpu=True, pretrained_base=True, **kwargs):
...
def get_icnet(nclass = 3, backbone='resnet50', pretrained=False, root='~/.torch/models',pretrained_base=True, **kwargs):
#     acronyms = {
...
#     from ..data.dataloader import datasets
    model = ICNet(nclass=3, backbone=backbone, pretrained_base=pretrained_base, **kwargs)
#     if pretrained:
