...
class ContextPath(nn.Module):
    def __init__(self, backbone='resnet18', pretrained_base=True, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        if backbone == 'resnet18':
            pretrained = resnet18_v1b(pretrained=pretrained_base, **kwargs)
        else:
...
def get_bisenet(nclass=3, backbone='resnet18', pretrained=False, root='~/.torch/models',
    ...
    model = BiSeNet(nclass=3, backbone=backbone, pretrained_base=pretrained_base, **kwargs)
    # if pretrained:
