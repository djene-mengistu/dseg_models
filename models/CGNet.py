...
def get_cgnet(nclass= 3, backbone='', pretrained=False, root='~/.torch/models', pretrained_base=True, **kwargs):
#     acronyms = {
...
#     from core.data.dataloader import datasets
    model = CGNet(nclass= 3, backbone=backbone, pretrained_base=pretrained_base, **kwargs)
#     if pretrained:
