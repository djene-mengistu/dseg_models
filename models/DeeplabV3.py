...
def get_deeplabv3(nclass=3, backbone='resnet50', pretrained=False, root='~/.torch/models',
                  pretrained_base=True, **kwargs):
    
    model = DeepLabV3(nclass=3, backbone=backbone, pretrained_base=pretrained_base, **kwargs)
    # if pretrained:
