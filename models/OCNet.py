...
class OCNet(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet18', oc_arch='asp', aux=False, pretrained_base=True, **kwargs):
...
class _OCHead(nn.Module):
    def __init__(self, nclass, oc_arch, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        if oc_arch == 'base':
            ...
            self.context = ASPOCModule(512, 512, 256, 512, norm_layer=norm_layer, **kwargs)
        else:
