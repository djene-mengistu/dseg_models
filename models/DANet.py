...
class DANet(SegBaseModel):
    ...
    def __init__(self, nclass, backbone='resnet18', aux=False, pretrained_base=True, **kwargs):
        ...
        self.head = _DAHead(512, nclass, aux, **kwargs)
...
def get_danet(num_class = 3, backbone='resnet18', pretrained=False,
    ...
    model = DANet(nclass = 3, backbone=backbone, pretrained_base=pretrained_base, **kwargs)
    # if pretrained:
